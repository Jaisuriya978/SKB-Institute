...
import { FaCheckCircle, FaGraduationCap, FaArrowRight, FaStar } from "react-icons/fa"
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ── BOTTOM FADE (blends into stats section below) ── */}
      <div
      ...
      <style>{`
        ...
        .h-badge{
          ...
          color:#aac2ff;font-size:.80rem;font-weight:700;
          letter-spacing:.09em;text-transform:uppercase;
        }

        /* Accent bar + tagline */
        .h-accent-bar{
          width:3px;height:40px;flex-shrink:0;border-radius:3px;
        ...
        .h-title{
          ...
          font-weight:900;line-height:1.06;letter-spacing:-2px;margin:0;
        ...
        .h-sub{
          ...
          line-height:1.78;max-width:450px;margin:0;
        }
        ...
        .h-btn-outline{
          ...
          letter-spacing:.015em;backdrop-filter:blur(6px);
        ...
        /* Trust row */
        .h-trust{color:rgba(255,255,255,.40);font-size:.76rem;font-weight:500;margin:0;}
        ...
        .h-stat-num{font-size:clamp(1.75rem,2.4vw,2.5rem);font-weight:800;color:#fff;line-height:1;letter-spacing:-1px;}
        .h-stat-lbl{color:rgba(255,255,255,.48);margin-top:7px;font-size:.70rem;font-weight:600;letter-spacing:.07em;text-transform:uppercase;line-height:1.4;}
      `}</style>
      ...
      <div className="container position-relative" style={{ zIndex: 3 }}>
        ...
        <div className="row">
          <div className="col-lg-6 col-xl-5">
            ...
            <div className="mb-3 ha ha1">
              <span className="h-badge"><FaGraduationCap />Admissions Open 2026</span>
            </div>
            ...
            <div className="d-flex flex-wrap gap-3 mt-4 ha ha5">
            ...
            <div className="d-flex align-items-center gap-2 mt-3 ha ha6">
              <span style={{ color: "#fbbf24", fontSize: ".82rem", letterSpacing: "1px" }}>★★★★★</span>
              <p className="h-trust">Trusted by 300+ students across Tamil Nadu</p>
            </div>
        ...
        {/* STATS ROW */}
        <div className="row g-3 ha ha6" style={{ marginTop: "38px" }}>
          {stats.map(([n, l]) => (
